...
///
/// `#[constant] static COEFFS: Constant<[f32; 4]> = Constant::UNINIT;`
/// becomes the mangled global `cuda_oxide_const_246e25db_COEFFS`, emitted
/// into PTX address space 4 (`.const`). The host-side `set_COEFFS` methods
/// generated by `#[cuda_module]` resolve the symbol by this exact name.
